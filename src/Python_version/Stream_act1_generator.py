...
if __name__ == '__main__':
    ...
    for person in ['1','3','4','5']:
        for s in range(3):
            f_Stream1 = open('/home/omari/Python/cad120/src/Long_streams/stream'+person+'_'+str(s)+'.txt', 'r')
            f_Stream2 = open('/home/omari/Python/cad120/src/Long_streams/act1_stream'+person+'_'+str(s)+'.txt', 'w')
            # qsrs = np.empty((29,3441))
            for count,line in enumerate(f_Stream1):
                ...
                if count<7:
                    ...
                    for d in range(1,len(data)):
                        if data[d] == '1' and data[d-1]=='0':
                            Act1.append('1')
                        elif data[d] == '0' and data[d-1]=='1':
                            Act1.append('2')
                        else:
                            Act1.append('0')
                    f_Stream2.write(header+':'+','.join(Act1)+'\n')
