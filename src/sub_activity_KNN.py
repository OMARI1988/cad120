...
#-------------------------------------------------------------------------------------#
def Training():
    	global activity,ID,activity_list
...
#########################################################################################
def listener():
    global G,spatial_nodes_counter,temporal_nodes_counter,labels,A1,G0,Activities,activity,ID,activity_list
	...
	if KNN_Timer == 5:
	    ...
	    print Main_Counter,activity,activity_list[int(result[0])]
	    KNN_Timer = 0
	    Main_Counter +=1
	else:
	    KNN_Timer += 1
